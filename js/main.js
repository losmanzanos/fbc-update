...
// Safari recalculates viewport height when browser chrome
// hides/shows, causing 100vh elements to jump. This sets
// a stable --vh custom property on page load only.
// ============================================================
(function() {
  function setVH() {
  ...
  // Set once on load — do NOT update on resize/scroll
  // That's the whole point: we want it stable
  setVH();

  // Only update on orientation change (legitimate resize), not scroll
